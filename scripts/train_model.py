...
class RealMadridModelTrainer:
    ...
    def load_data(self, file_path='combined_matches.csv'):
        ...
        try:
            ...
            print(f"Dataset dimuat: {len(df)} pertandingan")
            return df
    ...
    def evaluate_model(self, X_test, y_test):
        ...
        # Memastikan target_encoder sudah di-fit
        ...
        # Menghitung skor Brier untuk setiap kelas
        brier_scores = []
    ...
    def save_model(self, file_path='real_madrid_model.pkl'):
        """Menyimpan model, feature engineer, dan target encoder"""
        model_data = {
            'model': self.model,
...
def main():
    ...
    # Memisahkan data (pemisahan kronologis)
